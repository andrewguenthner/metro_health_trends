...
d3.csv("../static/data/trend_data.csv").then( function(trendTypeData) {
    ...
    Object.keys(trendArrays).forEach((itemToGraph,i) => {
        ...
        chart_g1.append("text")
            ...
            .attr("transform", `translate(${-0.5 * graphMargin.left}, ${0.5 * (graphHeight - graphMargin.top - graphMargin.bottom)}) rotate(-90)`)
        ...
        chart_g1.append("text")
            .attr("text-anchor", "middle")
            .attr("transform", `translate(${graphWidth / 2}, ${-0.5 * graphMargin.top})`)
            .classed("axis-title", true)
